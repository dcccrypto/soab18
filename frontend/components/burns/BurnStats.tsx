    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-orange-500">To Be Burned</h3>
          <div className="p-2 rounded-lg bg-orange-500/10">
            <Flame className="text-orange-500" />
          </div>
        </div>
        <p className="text-2xl font-bold text-white">
          {formatNumber(stats.toBeBurnedTokens)} SOBA
        </p>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-green-500">Value To Be Burned</h3>
          <div className="p-2 rounded-lg bg-green-500/10">
            <DollarSign className="text-green-500" />
          </div>
        </div>
        <p className="text-2xl font-bold text-white">
          ${formatNumber(stats.toBeBurnedValue, 2)}
        </p>
        <p className="text-sm text-gray-400 mt-1">
